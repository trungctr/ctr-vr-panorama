...
class NodeMaterial extends ShaderMaterial {
	...
	setup(builder) {
		...
		if (this.fragmentNode === null) {
			...
			resultNode = this.setupOutput(
				builder,
				vec4(outgoingLightNode, diffuseColor.a)
			)
	...
	setupClipping(builder) {
		const { globalClippingCount, localClippingCount } =
	...
	setupOutput(builder, outputNode) {
		...
		if (this.toneMapped === true && toneMappingNode) {
			outputNode = vec4(
				toneMappingNode.context({ color: outputNode.rgb }),
				outputNode.a
			)
		}
