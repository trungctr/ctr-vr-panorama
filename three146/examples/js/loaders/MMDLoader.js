;(function () {
	...
	const DEFAULT_TOON_TEXTURES = [
		...
		'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACAAAAAgCAYAAABzenr0AAAAOUlEQVRYR+3WMREAMAwDsYY/yoDI7MLwIiP40+RJklfcCCBAgAABAgTqArfb/QMCCBAgQIAAgbbAB3z/e0Fthree1462cAAAAAElFTkSuQmCC',
				...
				for (let i = 0; i < data.metadata.boneCount; i++) {
					...
					for (let j = 0, jl = ik.links.length; j < jl; j++) {
						...
						if (ik.links[j].angleLimitation === 1) {
							...
							rotationMin[0] = tmp1
							rotationMin[1] = tmp2
							link.rotationMin = new THREE.Vector3().fromArray(
								rotationMin
							)
							link.rotationMax = new THREE.Vector3().fromArray(
								rotationMax
							)
						}
